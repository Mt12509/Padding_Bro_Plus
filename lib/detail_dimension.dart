...
class DetailDimensionPage extends StatefulWidget {
  ...
  @override
  State<DetailDimensionPage> createState() => _DetailDimensionPageState();
}

class _DetailDimensionPageState extends State<DetailDimensionPage> {
      ...
      Navigator.push(
        ...
        MaterialPageRoute(
          builder: (context) => ThirdPage(
            ...
            wheel3Result: widget.wheel3Result,
            wheel4Result: selectedValue!,
          ),
        ),
      );
    }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Estrazione Dimensione Dettaglio'),
      ),
      body: Column(
        ...
        children: [
          const Padding(
            ...
            child: Column(
              children: [
                Text(
                  'Ruota della Dimensione del Dettaglio',
                  style: TextStyle(
                    fontSize: 24,
                ...
                SizedBox(height: 8),
                Text(
                  'Gira la ruota per scoprire la dimensione del dettaglio del padding selezionata casualmente.',
                  style: TextStyle(
                    fontSize: 16,
